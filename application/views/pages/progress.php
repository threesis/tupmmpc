...
<html lang="en">
  ...
  <head>
    ...
    <link href="<?php echo base_url() ?>assets/css/progress.css" rel="stylesheet">
  ...
  <body id="page-top">
    ...
    <div class="container my-5">
      <div class="row">
        <div class="col-md-8 mx-auto">
          <div class="card">
            <div class="card-header"><h5 class="card-title">Process</h5></div>
              <div class="card-body" id="first">
                <div class="progress mb-5">
                  <div class="progress-bar" id="progressbar" style="width: 0" role="progressbar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <h3>CHUCHUCHCU</h3>
              </div>
              <div class="card-footer">
                <button class="btn btn-primary float-right" id="nextBtn">Next</button>
              </div>
          </div>
        </div>
      </div>
    ...
    <script src="<?php echo base_url() ?>assets/css/progress.js"></script>
