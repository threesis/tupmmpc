...
<html lang="en">
  ...
  <body id="page-top">
   ...
   <!-- Navigation -->
       ...
       <!-- Service -->
        ...
        <script type="text/JavaScript">
          ...
          function get_officers(){
            $.ajax({
              type: 'ajax',
              url: '<?php echo base_url() ?>home/get_officers',
              async: false,
              dataType: 'json',
              success: function(data) { 
                var column = ''; 
                ...
                $('#returnOfficers').html(column);
              },
                error: function() {
                  $('#returnOfficers').html('<p class="alert alert-danger alert-dismissable fade show text-center" role="alert">Could not get data from the database!</p>').fadeIn('slow');
                }
            });
          }
          ...
          function getWebsiteInfos(){
            $.ajax({
              ...
              success: function(data) {
                ...
                $('#returnFb').attr('href', fb);
                $('#returnTwitter').attr('href', twitter);
                $('#returnWebsite').attr('href', website);
              }, 
                error: function() {
    ...
    <!-- EDIT POST MODAL -->
    <div class="modal fade" id="openSendMessageModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLongTitle">What's your message?</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body px-4" id="edit-post">
            <div class="form-group">
              <input class="form-control title-txt mt-2" type="text" placeholder="Name">
              <input class="form-control title-txt mt-2" type="text" placeholder="Email">
              <input class="form-control title-txt mt-2" type="text" placeholder="Subject">
              <textarea class="form-control my-2" id="textarea" rows="5" placeholder="Message"></textarea>
            </div>
          </div>
          <div class="modal-footer">
            <div class="mx-auto">
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
              <button type="button" class="btn btn-info" data-toggle="modal" data-target="#disapprovedLoanNote">Send</button>
            </div>
          </div>
        </div>
      </div>
